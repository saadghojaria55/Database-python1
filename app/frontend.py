...
class Window(object):
    def __init__(self,window):
        ...
        self.list1 = Listbox(window, height=8, width=35)
        self.list1.grid(row=5, column=0, rowspan=8, columnspan=2)
		# self.list2 = MultiListbox(window,(('Product',20),('Seller',20),('Price',20),('Qty',20)))
		# self.list2.grid(row=5, column=0, rowspan=8, columnspan=2)
    ...
    def add_command(self):
        ...
        self.list1.delete(0, END)
        self.list1.insert(END, (self.product_text.get(), self.seller_text.get(), self.price_text.get(), self.qty_text.get()))
